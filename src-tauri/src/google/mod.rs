...
// Helper: save a setting to the settings table
...
// Helper: get a setting from the settings table
...
pub async fn get_valid_access_token(pool: &DbPool) -> Result<String, String> {
    let access_token = crate::security::get_secret(pool, "google_access_token")?
    ...
    crate::security::save_secret(pool, "google_access_token", &new_access_token)?;
