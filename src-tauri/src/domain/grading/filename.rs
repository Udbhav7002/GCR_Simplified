...
pub fn parse_filename(file_name: &str) -> ParsedFilename {
    const STOPWORDS: &[&str] = &[
        "assignment", "assign", "asg", "hw", "homework", "final", "midterm",
        "mid", "term", "endsem", "sem", "semester", "exam", "test", "quiz",
        "ca", "ia", "report", "project", "submission", "sub", "upload",
        "file", "doc", "pdf", "new", "page", "scan", "img", "photo",
        "sheet", "answer", "ans", "question", "ques", "qp",
    ];
